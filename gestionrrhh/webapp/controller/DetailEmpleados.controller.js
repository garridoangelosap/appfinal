...
function (Controller, MessageBox, NumberFormat) {
    ...
    return Controller.extend("sapuifinal.gestionrrhh.controller.DetailEmpleados", {
        //onInit se ejecuta al comienzo y carga los modelos para los archivos, el historial y los salarios
        onInit: function () {
        ...
        onAscender: function(oEvent){
            ...
            if(!this._oDialogAscender){
                this._oDialogAscender = sap.ui.xmlfragment("AscenderFragment","sapuifinal.gestionrrhh.fragment.AscenderEmpleado",this);
