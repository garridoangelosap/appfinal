		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "RRHH",
									"targetURL": "#sapuifinalgestionrrhh-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapuifinalgestionrrhh-display": {
								"semanticObject": "sapuifinalgestionrrhh",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sapuifinal.gestionrrhh",
									"url": sap.ui.require.toUrl("sapuifinal/gestionrrhh")
								}
							}
						}
					}
